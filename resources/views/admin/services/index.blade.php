...
@section('content')
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">{{trans('services.servicesShowAll')}}</h3>
...
@section('scripts')
    ...
    <script>
        function softDeleteservices(id) {
            Swal.fire({
                title: 'Delete Type',
                icon: 'warning',
