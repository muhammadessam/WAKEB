...
@section('content')
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">{{trans('services.servicesAdd')}}</h3>
        </div>
        ...
        <div class="row col-sm-offset-1">
            <div class="col-md-6">
                ...
                <div class="nav-tabs-custom">
                    ...
                    <form role="form" action="{{route('storeService')}}" method="post"
                                ...
                                <div class="tab-pane {{$lang->id==1 ?'active':''}}" id="tab{{$lang->id}}">
                                    ...
                                    <div
                                        ...
                                        <textarea
                                            ...
                                            placeholder="{{trans('services.serviceDescriptionEnter_'.$lang->lang)}}">{{old('description_'.$lang->lang)}}</textarea>
                        ...
                        <div class="box-footer">
                            <button type="submit"
                                    class="btn btn-primary">{{trans('services.servicesAdd')}}</button>
                        </div>
                    </form>
                </div>
            </div>
...
@section('scripts')
    @if(session()->has('message'))
        <script>
            ...
            Toast.fire({
                icon: 'success',
                title: '{{trans('services.serviceAddSuccessfully')}}'
            })
        </script>
    @endif
@endsection
