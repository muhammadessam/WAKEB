...
@section('content')
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">{{trans('Edit')}}</h3>
        </div>
        ...
        <div class="row col-sm-offset-1">
            <div class="col-md-6">
                ...
                <div class="nav-tabs-custom">
                    ...
                    <form role="form" action="{{route('sliderUpdate', $slider)}}" method="post"
                                ...
                                <div class="tab-pane {{$lang->id==1 ?'active':''}}" id="tab{{$lang->id}}">
                                    <div class="form-group {{$errors->has('name_'.$lang->lang) ? 'has-error' : ''}}">
                                        ...
                                        <input type="text" class="form-control" id="productName"
                                               ...
                                               @foreach($slider->trans as $trans) @if($trans->lang_id==$lang->id) value="{{$trans->name}}" @endif @endforeach>
                                    ...
                                    <div
                                        ...
                                        <textarea
                                            ...
                                            placeholder="{{trans('products.productDescriptionEnter_'.$lang->lang)}}">@foreach($slider->trans as $trans){{$trans->lang_id == $lang->id ? $trans->description :''}}@endforeach</textarea>
